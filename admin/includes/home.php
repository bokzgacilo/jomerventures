      <div class="main-panel">
        <div class="content-wrapper">
          ...
          <div class="row">
            ...
            $total_reserve = mysqli_query($conn, "SELECT *,COUNT(id) as total,SUM(price_to_pay) as OVERALL FROM proceed_to_pay WHERE type='reserve'");
            $treserve=mysqli_fetch_array($total_reserve);

            $total_unpaid = mysqli_query($conn, "SELECT *,COUNT(id) as total,SUM(price_to_pay) as OVERALL FROM proceed_to_pay WHERE status = 'UNPAID' OR status = 'Waiting for Payment'");
            ...
            <div class="col-md-6 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                    ...
                    <a href="REPORT/daily.php" class="btn btn-success m-1"><i class="dwn"></i> Daily Data Report</a>
                    <a href="REPORT/weekly.php" class="btn btn-success m-1"><i class="dwn"></i> Weekly Data Export</a>
                    <a href="REPORT/monthly.php" class="btn btn-success m-1"><i class="dwn"></i> Monthly Data Export</a>
                    <a href="REPORT/annually.php" class="btn btn-success m-1"><i class="dwn"></i> Annual Data Export</a>
                     <br>
                     <br>
                  <div class="row">
                    <div class="col-12">
