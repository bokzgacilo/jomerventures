...
<head>
  ...
  <link rel="shortcut icon" href="jomer-seal.png" type="image/x-icon">
  <title>JOMERVENTURES | ADMIN</title>
  <!-- plugins:css -->
  ...
  <script src="../client/js/jquery-3.6.3.min.js"></script>
  <script>
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand brand-logo mr-5" href="index.php?view"><img src="jomer-seal.png" class="mr-2" alt="logo"/>Jomer Ventures</a>
        <a class="navbar-brand brand-logo-mini" href="index.php?view"><img src="jomer-seal.png" alt="logo"/></a>
      </div>
    ...
    <div class="container-fluid page-body-wrapper">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        <ul class="nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?view=<?php echo 'PAYMENTS'; ?>">
              <i class="icon-grid menu-icon"></i>
      ...
      <?php } else if($_GET['view'] == 'PAYMENTS'){ ?>
      <?php include('includes/payments.html'); ?>
