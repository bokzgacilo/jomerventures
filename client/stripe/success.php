...
if(!empty($_GET['session_id'])){
	...
	if ( !empty($result->num_rows) && $result->num_rows > 0) {
        ...
        if(empty($api_error) && $checkout_session){
            ...
            name,
            email,
            item_name,item_number,item_price,item_price_currency,paid_amount,paid_amount_currency,txn_id,payment_status,checkout_session_id,created,modified) VALUES('".$name."','".$email."','".$rowproduct['name']."','".$rowproduct['id']."','".$rowproduct['price']."','PHP','".$paidAmount."','".$paidCurrency."','".$transactionID."','".$paymentStatus."','".$session_id."',NOW(),NOW())"; 
...
<body class="App">
	...
	<div class="wrapper">
		<?php if(!empty($paymentID)){ ?>
			...
			<p><b>Price:</b> <?php echo $rowproduct['price'].' '.$rowproduct['paid_currency']; ?></p>
		<?php } ?>
